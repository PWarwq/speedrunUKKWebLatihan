...
<body>
    ...
    <div class="flex-1 mx-30 my-15 bg-blue-300 rounded-lg p-30 shadow-lg">
        <form action="" class="flex flex-col gap-5 justify-center items-center">
            <p class="bg-blue-500 text-white font-bold rounded-lg px-3 py-2">Register</p>
            ...
            <button type="submit" class="bg-blue-500 rounded-lg px-3 py-2 font-semibold text-white shadow-lg w-60">Register</button>
        </form>
    </div>
